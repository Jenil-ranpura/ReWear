...
/** Landing hero (§1/§13): intro + primary CTAs. Featured carousel arrives in Phase 5. */
  ...
  return (
    <section className="rounded-2xl bg-white p-10 text-center shadow-sm ring-1 ring-stone-200">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-lg text-stone-600">
        ReWear is a community clothing-exchange platform. List the garments you no longer wear, swap
        them directly with others, or redeem them through points — and keep usable clothing out of
        landfill.
      </p>
